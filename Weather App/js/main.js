...
//To Get Location with HTML5 API
...
async function getWeatherData() {
    ...
    //alert('fetch');
    try{
    apiResponse = await fetch(`http://localhost:5000/apikey`, {method:'POST'});
    //alert('respons'+ apiResponse);
    responseData = await apiResponse.json();
    //alert('recieving'+JSON.stringify(responseData));
    console.log(responseData);
    displayTodayWeather();
